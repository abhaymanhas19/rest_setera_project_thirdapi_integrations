...
schema_view = get_swagger_view(title="Rest API My-Setera ViEW")
...
schema_view = get_schema_view(
    openapi.Info(
        title="SETERA API",
        default_version="v1",
        _url="https://xyz.weuselinux.com/",
        description="SETERA api documentation MY_BACKEND",
        # schemes = ['https'],
    ),
    public=True,
...
urlpatterns = [
    ...
    path("api/dna/", include("apps.dna.urls")),
